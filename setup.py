...
def write_version_file(version):
    ...
    if os.path.isfile(version_file) is False:
        with open(f"src/{version_file}", "w+") as f:
...
setup(
    name="median_marginalized",
    description="Distributions which marginalize over the uncertainty ina median variance estimate",
    author="Colm Talbot",
    author_email="ctalbot@caltech.edu",
    license="MIT",
    version=VERSION,
